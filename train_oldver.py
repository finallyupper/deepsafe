...
def train(configs, 
    ...
    for epoch in range(epochs): 
        ...
        with torch.no_grad():
            ...
            print(f"Til: {train_image_loss}, Tdl: {train_image_df_loss}, Tga: {train_gan_loss}",
...
def main():
    ...
    message_criterion = nn.BCELoss(reduction='sum') 
    adversarial_loss = nn.BCELoss(reduce='sum') 
